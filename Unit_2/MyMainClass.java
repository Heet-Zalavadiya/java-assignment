...
class MyArrMeth {
    ...
    int sumArr(int[] a) {// meth-3------------
        int sum = 0;
        /*
         * write
         * missisng
         * code to find sum of all array elements
         */
        for (int i = 0; i < a.length; i++) {
            sum += a[i];
        }
    ...
    double avgArr(int[] a) {// meth-4------------
         ...
         * write the
         * missisng
         * code to find avg of all array elements
         */
        int sum = sumArr(a);
        avg = sum / a.length;
        return avg;
...
public class MyMainClass {
    public static void main(String[] args) {
        ...
        arm.sumArr(a);// call meth-4
        System.out.println("sum=" + arm.sumArr(a));
        /* write the missing code to call avgArr() */
        arm.avgArr(a);
        System.out.println("avg=" + arm.avgArr(a));// call meth-5
        sc.close();
    }
}